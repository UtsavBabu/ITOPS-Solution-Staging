...
const PRODUCT_META: Record<string, { gradient: string; glyph: ReactElement; label: string }> = {
  "website-api-monitoring": {
    label: "Website & API Monitoring",
    gradient: "linear-gradient(135deg, #0e7490, #22d3ee)",
    glyph: (
      <path
        d="M12 3a9 9 0 100 18 9 9 0 000-18zm0 0c2.5 2.4 3.8 5.6 3.8 9s-1.3 6.6-3.8 9m0-18C9.5 5.4 8.2 8.6 8.2 12s1.3 6.6 3.8 9M3.5 9h17M3.5 15h17"
        stroke="#fff"
        strokeWidth="1.7"
        fill="none"
        strokeLinecap="round"
  ...
  "security-monitoring": {
    ...
    glyph: (
      <path
        d="M12 3l7 3v5c0 4.6-3 8.6-7 10-4-1.4-7-5.4-7-10V6l7-3zm-2.8 9.2l2 2 3.8-4"
        stroke="#fff"
        strokeWidth="1.7"
        fill="none"
        strokeLinecap="round"
  ...
  "kada-nigrani": {
    ...
    glyph: (
      <path
        d="M4 5.5h16v5H4zM4 13.5h16v5H4zM7 8h.01M7 16h.01M11 8h4M11 16h2"
        stroke="#fff"
        strokeWidth="1.7"
        fill="none"
        strokeLinecap="round"
...
const FALLBACK = {
  ...
  glyph: (
    <path d="M4 7l8-4 8 4-8 4-8-4zm0 5l8 4 8-4M4 17l8 4 8-4" stroke="#fff" strokeWidth="1.7" fill="none" strokeLinecap="round" strokeLinejoin="round" />
  ),
};

export function ProductIcon({ itemKey, size = 44 }: { itemKey: string | null; size?: number }) {
  const meta = (itemKey && PRODUCT_META[itemKey]) || FALLBACK;
  return (
    <span
      aria-hidden
      className="grid shrink-0 place-items-center rounded-xl shadow-[0_8px_24px_-8px_rgba(0,0,0,0.6)]"
